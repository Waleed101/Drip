...
?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Add Earth Stations</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
error_reporting(0);
      if (isset($_GET["submit"])) {
		...
		if ($conn->query($sql) === TRUE) {
		   echo '<div class="alert alert-success">The Earth Station has been successfully added!</div>';
		} else {
		  echo '<div class="alert alert-danger">There was an error adding this Earth Station. The support team has been notified!</div>';
		}
		  	}
    ?>
                   <?php
		...
		<object data="addpoint.php?q=<?php echo $id;?>" width="100%" height="900"></object>
