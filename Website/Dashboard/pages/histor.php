...
?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Historical Data Search</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="row">
               <div>
                   <form method="GET" action="historResults.php">
		                  
                    <div class="col-lg-12">
                    <h4>Select atleast one of the below dropdowns to continue!</h4><br>
                    <div class="col-lg-3"><label><b>Date: </b></label><input type="date" class="form-control" name="date"></div> 
                    <div class="col-lg-3">
                    <label><b>Earth Station: </b></label>
				  ...
				  if ($result->num_rows > 0) {
						    // output data of each row
				     while($row = $result->fetch_assoc()) {
				     	echo '<option value="'. $row['ESID'] .'">'. $row['name'] .'</option>';
				      }}
				?>
                        </select>
                    </div> 
				  ...
				  for($x = 0; $x != $length; $x++)
				  {
					  ...
					  $sql = "SELECT * FROM PlantID WHERE PlantID =$plants[$x]";
				...
				?>
                    ...
                    <div class="col-lg-4">
              <input type="submit" class="btn btn-primary btn-lg btn-block" value="Submit!" name="submit"></div>
