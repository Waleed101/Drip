<html>
	...
	<body> <div class="row">
             <div class="col-lg-12">
			    ...
			    if ($result->num_rows > 0) {
				   ...
				   while($row = $result->fetch_assoc()) {
				    	...
				    	$farmid = $row['FarmID'];
				    	$name = $row['name'];
				    	$sensOne = $row['Type_SENS1'];
				    	$sensTwo = $row['Type_SENS2'];
				    	$sensThree = $row['Type_SENS3'];
				    	$lat = $row['lat'];
				    	$lon = $row['lon'];
				    	$plantId = $row['PlantID'];	    
				    }}
                            ...
                            if($l == 1)
                            	$result1 = '<div class="alert alert-success">The Earth Station has been successfully edited!</div>';
                     	    echo $result1;
                     	    ?> 
		...
		<script>
		 ...
		 <div class="col-lg-6">
                                    <form method="GET" action="editES.php">
                                        <div class="form-group">
                                            <input type="hidden" name="l" value="1">
                                            
                                            <label>Earth Station ID Number: </label>
                                            <input class="form-control" name="esid" value="<?php echo $esid;?>">
						...
						?>
                                            ...
                                            <select class="form-control">
                                               <?php
                                                $sql = "SELECT * FROM FarmInfo WHERE FarmID =$farmid";
